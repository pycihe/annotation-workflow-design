# Extract development data for tweet and reply processing
# Requires dev.json file to be present in the same directory
...
max_len = 0
header_list = []
twt = open("dev_sample_tweets.txt", "w")
rep = open("dev_sample_replies.txt", "w")
tweets = []
replies = []
with open('dev.json') as cases:
