# Extract test data for tweet and reply processing
# Requires test.json file to be present in the same directory
...
max_len = 0
header_list = []
twt = open("test_sample_tweets.txt", "w")
rep = open("test_sample_replies.txt", "w")
tweets = []
replies = []
with open('test.json') as cases:
